...
import { ArrowRightLeft, Calendar, Clock, User } from 'lucide-react';
...
export default function HandoffList({ schedule, config }: HandoffListProps) {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        {relevantHandoffs.map((handoff, index) => (
          <div key={`${handoff.date}-${index}`} className="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
